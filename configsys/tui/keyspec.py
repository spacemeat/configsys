...
KNOWN_ACTIONS = {
    ...
    'profiles': {'scope', 'toggle-member', 'toggle-active', 'new', 'delete', 'include', 'method',
                 'where', 'group', 'machine-target', 'attr-filter', 'add-to-profile', 'clone',
                 'toggle-install', 'stage', 'stage-uninstall', 'disp-interesting', 'disp-seen',
                 'orphan-ignore'},
...
ACTION_LABELS = {
    ...
    'scope': 'scope catalog to profile ↔ all', 'toggle-member': 'include / exclude subprofile', 'toggle-active': 'activate / deactivate',
    'new': 'new', 'delete': 'delete', 'include': 'include another profile (+)', 'attr-filter': 'filter by attrs',
    'add-to-profile': 'add component(s) to a profile', 'clone': 'clone a system profile',
