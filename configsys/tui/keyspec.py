...
KNOWN_ACTIONS = {
    ...
    'profiles': {'scope', 'track-all', 'track-one', 'select-all', 'method', 'machine-target',
                 'attr-filter', 'toggle-install', 'stage-uninstall', 'disp-interesting', 'disp-seen',
                 'disp-interesting-all', 'disp-seen-all', 'mark-all-seen', 'orphan-ignore'},
...
ACTION_LABELS = {
    ...
    'scope': 'scope catalog to profile ↔ all', 'attr-filter': 'filter by attrs',
    ...
    'mark-all-seen': 'mark all NEW seen',
